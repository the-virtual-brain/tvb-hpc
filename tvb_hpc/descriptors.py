...
The classes herein are intended to make maintenance easier by enforcing
stated constraints which are more typical in static typing situations.
...
class Final(object):
    ...
    def __set__(self, instance, value):
        ...
        if state.initialized:
            ...
            # TODO check owner's __init__ is in call stack?
